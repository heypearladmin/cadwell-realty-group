 ...
 * Em-dashes avoided per brand voice. All image src paths use existing filenames
 * (the visual asset team replaces the underlying files; filenames stay stable).
 */
...
export const googleReviewStats = {
  ...
  href: "https://www.google.com/search?q=Cadwell+Realty+Group+Albany+Oregon",
};
