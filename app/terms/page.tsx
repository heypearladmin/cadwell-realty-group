...
export const metadata: Metadata = {
  ...
  description:
    "Terms governing the use of the Cadwell Group website, services, SMS messaging, and AI-assisted communications.",
};
...
export default function TermsPage() {
  return (
    <LegalShell
      eyebrow="Legal"
      title="Terms & Conditions"
      description="The terms governing the use of the Cadwell Group website, services, SMS messaging, and AI-assisted communications."
      ...
      sections={[
        {
          ...
          body: (
            <p>
              By accessing or using the Cadwell Group website and services, you
        ...
        },
        {
          ...
          body: (
            <p>
              Cadwell Group provides real estate brokerage services in Albany,
          ...
          body: (
            <>
              <p>
                ...
                text messages from Cadwell Group at the phone number you
          ...
          body: (
            <>
              <p>
                ...
                phone calls from Cadwell Group, including automated and
          ...
          body: (
            <>
              <p>
                ...
                exchanged with Cadwell Group. Standard messaging rates from
                your wireless carrier apply. Cadwell Group is not responsible
        ...
        },
        {
          ...
          body: (
            <p>
              All Cadwell Group branding, copy, photography, designs, and
              content are the property of Cadwell Group or its licensors.
        ...
        },
        {
          ...
          body: (
            <p>
              Cadwell Group services and the website are provided on an as-is
        ...
        },
        {
          ...
          body: (
            <p>
              To the fullest extent permitted by law, Cadwell Group is not
        ...
        },
        {
          ...
          body: (
            <p>
              Your use of Cadwell Group services is also governed by our{" "}
              <a
                href="/policies"
