...
const KNOW_BLOCKS = [
  {
    ...
    body: "Greater Albany Public Schools paths, sidewalks, walk-to-coffee distance, and the small frictions that matter once you live somewhere. A working list, updated as the neighborhood changes.",
  },
  {
    eyebrow: "Outdoors",
    title: "Rivers, trails, and parks",
    body: "Closest river access, shaded walks, and the parks locals actually use. Where to be on a Saturday morning and where to go when you need quiet on a Tuesday.",
  },
  {
    eyebrow: "Market",
    title: "How homes move here",
    body: "Inventory trends, common floor plans, builder mix, and the price bands that move quickly. Plain English, current as of the season.",
  },
];
  ...
  return (
    <main id="main" className="bg-paper">
      ...
      <section className="relative isolate overflow-hidden bg-ink text-paper">
        ...
        <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 bg-gradient-to-t from-ink via-ink/55 to-ink/10" />
        ...
        <div className="section-wrap relative py-24 pt-32 md:py-32 md:pt-40 lg:py-40 lg:pt-48">
          <div className="flex items-center gap-3">
            <Link href={site.neighborhoodsPath} className="caption !text-paper/65 transition-colors duration-cinema ease-cinema hover:!text-paper">
              Neighborhoods
            </Link>
            <span aria-hidden className="h-px w-6 bg-paper/40" />
            <span className="caption !text-paper/65">Albany, Oregon</span>
          </div>
      ...
      <section className="section-wrap py-20 md:py-28 lg:py-32">
        ...
        <div className="mt-16 grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-7">
          {KNOW_BLOCKS.map((b) => (
            <article key={b.title} className="rounded-[24px] border border-ink/[0.08] bg-paper p-7 shadow-surface md:p-8">
        ...
        <div className="section-wrap relative">
          <div className="grid gap-y-8 lg:grid-cols-12 lg:items-end">
            <div className="lg:col-span-8">
              ...
              <h2 className="display-lg mt-6 text-ink">Tour {n.title} with Jason.</h2>
            ...
            {related.map((r) => (
              <Link key={r.slug} href={r.href} className="group block">
                <div className="relative aspect-[4/3] w-full overflow-hidden rounded-[24px] bg-ink/[0.04] shadow-surface ring-1 ring-ink/[0.06] transition-shadow duration-cinema ease-cinema group-hover:shadow-surface-hover">
                  ...
                  />
                  <div aria-hidden className="pointer-events-none absolute inset-0 bg-gradient-to-t from-ink/45 via-ink/[0.08] to-transparent" />
                </div>
